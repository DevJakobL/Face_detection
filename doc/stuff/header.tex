...
%% Document properties %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\projname}{Gesichtserkennung }
\newcommand{\titel}{Gesichtserkennung}
\newcommand{\authorname}{Jakob Lambert}
\newcommand{\thesisname}{Medien Projekt}
\newcommand{\untertitel}{Gesichtserkennung mittels Neuronalen Netzen}
\newcommand{\Datum}{1 September 2018}
